    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-lg mb-4">
                Eventers is a comprehensive event management platform designed to simplify the process of creating, managing, and attending events. Whether you're an event organizer or an attendee, Eventer provides a seamless experience for all your event-related needs.
            </p>
