    ...
    <header className="sticky top-0 z-20 flex items-center justify-between gap-4 border-b border-[#EDEBF7] bg-white/80 px-4 py-3.5 backdrop-blur-md sm:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative">
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-44 overflow-hidden rounded-xl border border-[#EDEBF7] bg-white py-1.5 shadow-lg">
              <button className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-[#443F5C] hover:bg-[#F4F2FA]">
                <User size={16} /> Profile
              </button>
              <button className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-[#E5484D] hover:bg-[#FDF0F0]">
